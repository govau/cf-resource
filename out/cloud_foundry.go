...
type PAAS interface {
	...
	PushApp(manifest string, path string, currentAppName string, showLogs bool) error
}
...
func (cf *CloudFoundry) PushApp(manifest string, path string, currentAppName string, showLogs bool) error {
	args := []string{}
